...
name='map_perp_kperp_1_100000'
file_in(nn)=sprintf('%s/%s.mode%d',data_dir,name,nn)
file_out=sprintf('example_kperp_v%2.2d.tex',version)
#Plasma Parameters
kperp=0.001
kpar=0.001
beta=1.0
...
set label sprintf('$k_\parallel \rho_p=%4.3f$',kpar) at graph 1.25,1.75
...
plot \
file_in(mm) u 1:($5) w l lc rgb base_color dt 1 title '$\omega_{\textrm{r}}>0$' ,\
file_in(mm) u 1:(-$5) w l lc rgb base_color dt 2 title '$\omega_{\textrm{r}}<0$'
...
plot \
file_in(mm) u 1:($6) w l lc rgb base_color dt 1 title '$\gamma>0$' ,\
file_in(mm) u 1:(-$6) w l lc rgb base_color dt 2 title '$\gamma<0$'
...
plot \
file_in(mm) u 1:(-$35/sgn($5)) w l lc rgb base_color dt 1 title '$\gamma_p>0$' ,\
file_in(mm) u 1:($35/sgn($5)) w l lc rgb base_color dt 2 title '$\gamma_p<0$' ,\
...
plot \
file_in(mm) u 1:(-$35/sgn($5)) w l lc rgb base_color dt 1 title '' ,\
