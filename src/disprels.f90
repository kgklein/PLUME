   ...
   subroutine map_search
      ...
      if (refine) then
         ...
         do j = 1, nroots
            ...
            end if !end omega !=0 loop
         end do !end nroots loop
      end if !end refine loop
...
!-=-=-=-
  ...
  !! Scan index.
      ...
      end do!End (is) loop for first and second scan information
